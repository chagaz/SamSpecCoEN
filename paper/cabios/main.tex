...
For evaluation, we use three different networks: two also employed by~\ref{staiger2015} (KEGG, \teal{xxx genes and xxx interactions}, and I2D, \teal{xxx genes and xxx interactions}), and a random network.
