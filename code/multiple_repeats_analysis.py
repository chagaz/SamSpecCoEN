...
def get_selected_genes(min_number_folds, aces_data, features_list,
                       use_nodes, use_cnodes, network_root):
...
def final_cv_score(selected_features_list, aces_data, use_nodes,
...
def main():
    ...
    # Get results dir
    if args.cnodes:
        results_dir = "%s/results/cnodes" % args.repeat_path
    elif args.nodes:
        results_dir = "%s/results/nodes" % args.repeat_path
    elif args.sfan:
        results_dir = "%s/results/sfan" % args.repeat_path
    else:
